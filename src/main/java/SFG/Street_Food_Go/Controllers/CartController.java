...
public class CartController {
    ...
    public  CartController(RestaurantService restaurantService,ProductService productService,OrderProcessService orderProcessService){this.restaurantService = restaurantService;this.productService = productService; this.orderProcessService = orderProcessService;}
    ...
    public String viewOrder(@PathVariable Long rest_id, Model model,@ModelAttribute("OrderSelectionProductsDTO") OrderSelectionProductsDTO selected_order_details){
        ...
        for (int i = 0; i < selectedItems.size(); i++) {
            ...
            System.err.println("product id: "+allProductIdsChosen[i]);
        }
